...
const translations = {
  'zh-CN': {
    ...
    chat: { inputPlaceholder: '输入您的问题...', send: '发送', newChat: '新对话', guessYouWant: '猜你想问', tryAsking: '试试这样问：', loading: '倾听天机中...', selectModule: '选择功能', profile: '档案', uploadImage: '上传图片', voiceInput: '语音输入', copy: '复制', retry: '重试', copied: '已复制', you: '你' },
  ...
  'en': {
    ...
    chat: { inputPlaceholder: 'Ask your question...', send: 'Send', newChat: 'New Chat', guessYouWant: 'You Might Ask', tryAsking: 'Try asking:', loading: 'Consulting the spirits...', selectModule: 'Select Feature', profile: 'Profile', uploadImage: 'Upload Image', voiceInput: 'Voice Input', copy: 'Copy', retry: 'Retry', copied: 'Copied', you: 'You' },
  ...
  'ja': {
    ...
    chat: { inputPlaceholder: '質問を入力...', send: '送信', newChat: '新規チャット', guessYouWant: 'おすすめの質問', tryAsking: '聞いてみる:', loading: '天機を開いています...', selectModule: '機能を選択', profile: 'プロフィール', uploadImage: '画像をアップロード', voiceInput: '音声入力', copy: 'コピー', retry: '再試行', copied: 'コピーしました', you: 'あなた' },
  ...
  'ko': {
    ...
    chat: { inputPlaceholder: '질문을 입력하세요...', send: '보내기', newChat: '새 채팅', guessYouWant: '추천 질문', tryAsking: '다양한 질문:', loading: '천기를 듣고 있습니다...', selectModule: '기능 선택', profile: '프로필', uploadImage: '이미지 업로드', voiceInput: '음성 입력', copy: '복사', retry: '다시 시도', copied: '복사됨', you: '당신' },
  ...
  'es': {
    ...
    chat: { inputPlaceholder: 'Escribe tu pregunta...', send: 'Enviar', newChat: 'Nuevo chat', guessYouWant: 'Quizás quieras preguntar', tryAsking: 'Intenta preguntar:', loading: 'Consultando los espíritus...', selectModule: 'Seleccionar función', profile: 'Perfil', uploadImage: 'Subir imagen', voiceInput: 'Entrada de voz', copy: 'Copiar', retry: 'Reintentar', copied: 'Copiado', you: 'Tú' },
  ...
  'de': {
    ...
    chat: { inputPlaceholder: 'Stellen Sie Ihre Frage...', send: 'Senden', newChat: 'Neuer Chat', guessYouWant: 'Sie könnten fragen', tryAsking: 'Versuchen Sie zu fragen:', loading: 'Konsultiere die Geister...', selectModule: 'Funktion auswählen', profile: 'Profil', uploadImage: 'Bild hochladen', voiceInput: 'Spracheingabe', copy: 'Kopieren', retry: 'Wiederholen', copied: 'Kopiert', you: 'Sie' },
  ...
  'pt': {
    ...
    chat: { inputPlaceholder: 'Faça sua pergunta...', send: 'Enviar', newChat: 'Novo chat', guessYouWant: 'Você pode perguntar', tryAsking: 'Tente perguntar:', loading: 'Consultando os espíritos...', selectModule: 'Selecionar função', profile: 'Perfil', uploadImage: 'Enviar imagem', voiceInput: 'Entrada de voz', copy: 'Copiar', retry: 'Tentar novamente', copied: 'Copiado', you: 'Você' },
  ...
  'ar': {
    ...
    chat: { inputPlaceholder: 'اكتب سؤالك...', send: 'إرسال', newChat: 'محادثة جديدة', guessYouWant: 'يمكنك أن تسأل', tryAsking: 'حاول أن تسأل:', loading: 'استشارة الارواح...', selectModule: 'اختر الوظيفة', profile: 'الملف الشخصي', uploadImage: 'رفع صورة', voiceInput: 'ادخال صوتي', copy: 'نسخ', retry: 'إعادة المحاولة', copied: 'تم النسخ', you: 'أنت' },
  ...
  'ms': {
    ...
    chat: { inputPlaceholder: 'Tulis soalan anda...', send: 'Hantar', newChat: 'Cakap Baru', guessYouWant: 'Mungkin anda mahu bertanya', tryAsking: 'Cuba tanyakan:', loading: 'Merunding dengan roh...', selectModule: 'Pilih Fungsi', profile: 'Profil', uploadImage: 'Muat naik Gambar', voiceInput: 'Input Suara', copy: 'Salin', retry: 'Cuba Lagi', copied: 'Disalin', you: 'Anda' },
